...
namespace MyBakeryFinal.Migrations
{
    ...
    partial class DBBakeryContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyBakeryFinal.Entities.RecipesToOrders", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyBakeryFinal.Entities.RecipesToOrders", b =>
                {
                    b.HasOne("MyBakeryFinal.Entities.Order", "Order")
                        .WithMany()
                        .HasForeignKey("Order_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyBakeryFinal.Entities.Recipe", "Recipe")
                        .WithMany()
